...
class DataValidation:
    def __init__(
        ...
        try:
            logging.info(f"{'>>' * 20}Data Valdation log started.{'<<' * 20}")
        ...
        try:
            ...
            for file in all_files:
                if file not in self.data_validation_config.required_file_list:
                    ...
                    self.validation_error_message = f"{file} is not found in feature store"
    ...
    def initiate_data_validation(self) -> DataValidationArtifact:
        ...
        try:
            ...
            logging.info("Exited intiate_data_validation method of DataValidation class")
